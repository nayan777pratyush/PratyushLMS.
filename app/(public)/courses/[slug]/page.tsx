            ...
            <div className="order-1 lg:col-span-2">
                ...
                <div className="mt-8 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Badge className="flex items-center gap-1 p-3 py-1">
                ...
                <div className="mt-12 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            {course.chapters.reduce(
                                (total, chp) => total + chp.lessons.length,
                                0
                            ) ||  0 } Lessons
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        {course.chapters.map((chp, index) => (
                            <Collapsible key={chp.id} defaultOpen={index === 0}>
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-muted-foreground mt-1 text-left">
                                                                {chp.lessons.length} Lesson
                                                                {chp.lessons.length !== 1 ? "s" : ""}
                                                            </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <CollapsibleContent>
                                        <div className="border-t bg-muted/20">
                                            <div className="p-6 pt-4 space-y-3">
                                                {chp.lessons.map((les, lesIndex) => (
                                                    <div key={les.id} className="flex items-center gap-4 rounded-lg p-3 hover:bg-accent transition-colors group">
