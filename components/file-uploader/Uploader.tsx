...
interface iAppProps {
    ...
    fileTypeAccepted: "image" | "video"; // Add audio
}
...
export function Uploader({ onChange, value, fileTypeAccepted }: iAppProps) {
    ...
    async function handleRemoveFile() {
        ...
        try {
            ...
            toast.error("Error removing the file. Please try again")
    ...
    const { getRootProps, getInputProps, isDragActive} = useDropzone({ 
        ...
        maxFiles: 1,
        multiple: false,
        maxSize: fileTypeAccepted === "image" ? 5 * 1024 * 1024 : 5 * 1024 * 1024 * 1024,  // 5MB for images, 5GB for videos
